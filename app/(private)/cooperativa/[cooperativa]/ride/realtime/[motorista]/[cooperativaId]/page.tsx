                    ...
                    >
                          ...
                          destinoCoords && (
                            <Polyline
                              path={[
                                ...
                                { lat: destinoCoords[0], lng: destinoCoords[1] },
                              ]}
                              options={{
                                strokeColor: "#0070f3",
                                strokeOpacity: 0.8,
                      ...
                      {(() => {
                        ...
                        return (
                          origemCoords && (
                            <Marker
                              position={{ lat: origemCoords[0], lng: origemCoords[1] }}
                              ...
                              {activeInfoWindow === "origem" && (
                                <InfoWindow onCloseClick={() => setActiveInfoWindow(null)}>
                                  <div className="text-sm space-y-1">
                                    ...
                                    <div className="text-xs">{getOrigemAddress(viagem)}</div>
                                  </div>
                                </InfoWindow>
                              )}
                            </Marker>
                      ...
                      {(() => {
                        ...
                        return (
                          destinoCoords && (
                            <Marker
                              position={{ lat: destinoCoords[0], lng: destinoCoords[1] }}
                              ...
                              {activeInfoWindow === "destino" && (
                                <InfoWindow onCloseClick={() => setActiveInfoWindow(null)}>
                                  <div className="text-sm space-y-1">
                                    ...
                                    <div className="text-xs">{getDestinoAddress(viagem)}</div>
                                  </div>
                                </InfoWindow>
                              )}
                            </Marker>
                      ...
                      {/* Paradas (stops) - apenas para viagens do provider mobicity */}
                        ...
                        viagem.paradas?.map((parada, index) => {
                          ...
                          return (
                            <Marker
                              ...
                              onClick={() => setActiveInfoWindow(key)}
                              icon={{
                                path: google.maps.SymbolPath.CIRCLE,
                                scale: 6,
                                fillColor: "#7828c8",
                              ...
                              {activeInfoWindow === key && (
                                <InfoWindow onCloseClick={() => setActiveInfoWindow(null)}>
                                  <div className="text-sm space-y-1">
                                    ...
                                    {parada.nome && (
                                      <div className="text-xs text-gray-600">{parada.nome}</div>
                                    )}
                                    {parada.whatsapp && (
