    ...
    <div className="min-h-screen relative overflow-hidden bg-blue-50/50 dark:bg-gray-900">
      ...
      <div className="relative z-10 container mx-auto p-4 sm:p-8 max-w-7xl">
        ...
        <main className="space-y-8">
          {/* Select Cooperativa e Viagens Ativas na mesma linha */}
              ...
              <div className="relative flex-1 lg:max-w-md xl:max-w-lg">
                ...
                <div className="relative p-4 rounded-2xl">
                  <Select
                    ...
                    classNames={{
                      trigger:
                        "bg-white/15 dark:bg-white/8 backdrop-blur-xl border-blue-300/40 dark:border-white/15 min-h-[68px] hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300",
                      value:
                        "text-gray-800 dark:text-gray-200 text-base font-medium",
                      label:
                        "text-gray-700 dark:text-gray-300 text-sm font-semibold tracking-wide",
                      innerWrapper: "py-3",
                      listbox:
                        "bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl",
                      popoverContent:
                        "bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border-blue-200/30 dark:border-white/10",
                    }}
                  >
              ...
              <div className="relative p-12 rounded-3xl text-center">
                <div className="mb-4">
                  <div className="w-16 h-16 mx-auto bg-cyan-100/50 dark:bg-cyan-900/30 rounded-full flex items-center justify-center">
                    <svg
                      className="w-8 h-8 text-cyan-500 dark:text-cyan-400"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Escolha uma cooperativa para visualizar as viagens em tempo
                  real
                </p>
              </div>
            </section>
